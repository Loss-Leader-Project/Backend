...
import lossleaderproject.back.error.reviewException.ReviewCustomException;
import lossleaderproject.back.error.reviewException.ReviewErrorCode;
...
public class ReviewService {
    ...
    public Long save(PrincipalDetails principalDetails, Long orderNumber, Long storeId, ReviewRequest.ReviewPost reviewPost) {
        ...
        if (orders.getIsReview()) {
            throw new ReviewCustomException(ReviewErrorCode.DUPLICATE_ID);
        }
