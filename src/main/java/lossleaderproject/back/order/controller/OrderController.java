...
public class OrderController {
    ...
    @GetMapping("/purchase/{userId}/{storeId}/{orderNumber}")
    public ResponseEntity<PurchaseDetailsResponse> purchaseDetails(@PathVariable("userId") Long userId,
                                                                   @PathVariable("storeId") Long storeId,
                                                                   @PathVariable("orderNumber") Long orderNumber) {
        return new ResponseEntity<>(orderService.purchaseDetails(userId,storeId,orderNumber),HttpStatus.OK);
    }
